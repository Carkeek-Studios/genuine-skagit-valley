...
(function ($) {
  $(document).ready(function () {
    ...
    $(document).on("focus", '.venn-zone', function () {
      ...
      var content = $('.' + target).find('.image-rollover__hover_text').html();
      var $parent = $('.' + target).parents('.wp-block-carkeek-blocks-rollover-images');
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "jquery");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _slick_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./slick.js */ "./src/blocks/slider/slick.js");
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/slider/style.scss");
...
var _this = undefined,
    _jsxFileName = "/Users/pattyohara/Sites/wa-farmland-trust/app/public/wp-content/mu-plugins/carkeek-blocks/src/blocks/team-member/script.js";


var render = wp.element.render;

var popupGroups = document.querySelectorAll(".wp-block-carkeek-blocks-team-members");
popupGroups.forEach(function (popupGroup) {
  var layout = popupGroup.getAttribute('data-layout');
  var popups = popupGroup.querySelectorAll(".wp-block-carkeek-blocks-team-member");
  popups.forEach(function (popup) {
    var popupContent = popup.innerHTML;
    var triggerContent, name, title;

    if (layout == "grid") {
      triggerContent = popup.querySelectorAll(".wp-block-carkeek-blocks-team-member__initial");
      triggerContent = {
        __html: triggerContent[0].innerHTML
      };
    } else {
      ...
      triggerContent = {
        __html: '<div class="wp-block-carkeek-blocks-team-member__name">' + name + '</div>'
      };
    }

    render(wp.element.createElement(reactjs_popup__WEBPACK_IMPORTED_MODULE_1__["default"], {
      trigger: wp.element.createElement("div", {
        dangerouslySetInnerHTML: triggerContent,
        __self: _this,
        __source: {

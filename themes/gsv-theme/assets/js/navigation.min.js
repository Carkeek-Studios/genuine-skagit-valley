...
/* global gsvThemeScreenReaderText */
...
function toggleSubMenu(parentMenuItem, forceToggle) {
  ...
  if (parentMenuItemToggled) {
    ...
    toggleButton.setAttribute('aria-label', gsvThemeScreenReaderText.expand);
    ...
    toggleButton.setAttribute('aria-label', gsvThemeScreenReaderText.collapse);
  }
}
/**
...
function getDropdownButton() {
  ...
  dropdownButton.setAttribute('aria-label', gsvThemeScreenReaderText.expand);

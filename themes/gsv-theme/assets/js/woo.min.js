...
(function ($) {
  function setUpQty() {
    var plus = '<button type="button" class="quantity-button plus">+<span class="screen-reader-text">Add 1</span></button>';
    var minus = '<button type="button" class="quantity-button minus">-<span class="screen-reader-text">Subtract 1</span></button>';
  ...
  $(function () {
    ...
    $('.quantity-button').on('click', function (e) {
      e.preventDefault();
      var $input = $(this).parent('.number-input').find('.input-text.qty')[0];

 ...
 * * `gsv_theme()->is_primary_nav_menu_active()`
 * * `gsv_theme()->display_primary_nav_menu( array $args = [] )`
 */
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_nav_menus() {
		register_nav_menus(
			array(
				static::PRIMARY_NAV_MENU_SLUG   => esc_html__( 'Primary', 'gsv-theme' ),
				static::SECONDARY_NAV_MENU_SLUG => esc_html__( 'Secondary', 'gsv-theme' ),
				'gsv-theme-footer-social-nav'      => esc_html__( 'Footer', 'gsv-theme' ),
			)
		);
	}

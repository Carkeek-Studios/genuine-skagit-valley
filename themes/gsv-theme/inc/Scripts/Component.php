...
class Component implements Component_Interface {
	...
	protected function get_js_files() : array {
		...
		$js_files = array(
			'gsv-theme-global-js'  => array(
				'file'         => 'global.min.js',
				'dependencies' => array( 'jquery', 'gsv-theme-popover-js' ),
				'in_footer'    => true,
			),
			'gsv-theme-popover-js' => array(
	...
	public function register_global() {
		...
		foreach ( $js_files as $handle => $data ) {
			...
			$version = gsv_theme()->get_asset_version( $js_dir . $data['file'] );
			$asset   = $js_uri . gsv_theme()->get_asset_path( $data['file'] );

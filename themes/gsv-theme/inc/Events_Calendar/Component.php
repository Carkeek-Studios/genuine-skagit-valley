...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function initialize() {
		...
		add_action( 'gsv_theme_tribe_events_single_event_after_the_meta', array( 'Tribe__Events__iCal', 'single_event_links' ) );
	...
	public function register_additional_tax() {
		$labels = array(
			'name'          => _x( 'Organizer Categories', 'Taxonomy General Name', 'gsv-theme' ),
			'singular_name' => _x( 'Organizer Category', 'Taxonomy Singular Name', 'gsv-theme' ),
			'menu_name'     => __( 'Organizer Categories', 'gsv-theme' ),
		);
		$args   = array(
			'labels'            => $labels,
			'hierarchical'      => true,
	...
	public function tribe_events_ical_single_event_links( $links ) {
		...
		$html .= WP_Rig\gsv_theme()->make_social_share_links();
	...
	public function tribe_get_ticket_label_plural_lowercase( $label, $context ) {
		if ( 'check_in_app' == $context || 'woo_settings' == $context ) {
			return __( 'registration confirmation', 'gsv-theme' );
		}
		return __( 'registration', 'gsv-theme' );
	}
	...
	public function tribe_organizer_label_singular() {
		return __( 'Instructor/Moderator', 'gsv-theme' );
	}
	...
	public function tribe_organizer_label_plural() {
		return __( 'Instructors/Moderators', 'gsv-theme' );
	}
	...
	public function tribe_events_editor_default_template() {
		$template = array(
			...
			array(
				...
				array(
					...
					array(
						'core/paragraph',
						array(
							'placeholder' => __( 'Add Description...', 'gsv-theme' ),
						),
					),
					array(
						'core/heading',
			...
			array(
				...
				array(
					'title' => __( 'More Classes &amp; Events', 'gsv-theme' ),
				),
			),
		);
		return $template;
		...
		if ( function_exists( 'acf_register_block_type' ) ) {
			...
			acf_register_block_type(
				array(
					...
					'title'           => __( 'Class Instructor', 'gsv-theme' ),
					'description'     => __( 'Customize Instructor Details.', 'gsv-theme' ),
	...
	public function tribe_tickets_ticket_moved_email_subject() {
		return sprintf( __( 'Changes to your registration from %s', 'gsv-theme' ), get_bloginfo( 'name' ) );
	}

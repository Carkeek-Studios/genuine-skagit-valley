 ...
 * * `gsv_theme()->is_primary_sidebar_active()`
 * * `gsv_theme()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		register_sidebar(
			array(
				'name'          => esc_html__( 'Footer Upper', 'gsv-theme' ),
				'id'            => static::FOOTER_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Footer Widgets Top', 'gsv-theme' ),
		...
		register_sidebar(
			array(
				'name'          => esc_html__( 'Footer Lower', 'gsv-theme' ),
				'id'            => static::FOOTER_LOWER_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Footer Widgets Lower Section', 'gsv-theme' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div>',
				'before_title'  => '<h2 class="widget-title">',
				'after_title'   => '</h2>',
		...
		register_sidebar(
			array(
				'name'          => esc_html__( 'Footer Bottom', 'gsv-theme' ),
				'id'            => static::FOOTER_BOTTOM_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Footer Widgets Widgets Bottom', 'gsv-theme' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div>',
				'before_title'  => '<h2 class="widget-title">',
				'after_title'   => '</h2>',

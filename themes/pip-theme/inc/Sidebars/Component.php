 ...
 * * `pip_theme()->is_primary_sidebar_active()`
 * * `pip_theme()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		register_sidebar(
			array(
				'name'          => esc_html__( 'Footer Upper', 'pip-theme' ),
				'id'            => static::FOOTER_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Footer Widgets Top', 'pip-theme' ),
		...
		register_sidebar(
			array(
				'name'          => esc_html__( 'Footer Lower', 'pip-theme' ),
				'id'            => static::FOOTER_LOWER_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Footer Widgets Lower Section', 'pip-theme' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div>',
				'before_title'  => '<h2 class="widget-title">',
				'after_title'   => '</h2>',
		...
		register_sidebar(
			array(
				'name'          => esc_html__( 'Footer Bottom', 'pip-theme' ),
				'id'            => static::FOOTER_BOTTOM_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Footer Widgets Widgets Bottom', 'pip-theme' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div>',
				'before_title'  => '<h2 class="widget-title">',
				'after_title'   => '</h2>',
		...
		register_sidebar(
			array(
				'name'          => esc_html__( 'Blog Archive Intro', 'pip-theme' ),
				'id'            => static::BLOG_ARCHIVE_SLUG,
				'description'   => esc_html__( 'Place content that will appear on the blog archive below the title and above the filters', 'pip-theme' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div>',
				'before_title'  => '<h2 class="widget-title">',
				'after_title'   => '</h2>',

...
class Component implements Component_Interface {
	...
	public function action_customize_register( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				...
				'choices' => array(
					'title_tagline' => __( 'Display Title & Tagline', 'pip-theme' ),
					'title_only'    => __( 'Display Title Only', 'pip-theme' ),
					'tagline_only'    => __( 'Display Tagline Only', 'pip-theme' ),
					'none'          => __( 'Hide Title & Tagline', 'pip-theme' ),
				),
			)
		);
		...
		$wp_customize->add_section(
			'theme_options',
			array(
				'title'    => __( 'Theme Options', 'pip-theme' ),
	...
	public function action_enqueue_customize_preview_js() {
		wp_enqueue_script(
			'pip-theme-customizer',
			get_theme_file_uri( '/assets/js/customizer.min.js' ),
			array( 'customize-preview' ),
			pip_theme()->get_asset_version( get_theme_file_path( '/assets/js/customizer.min.js' ) ),
			true
		);
	}
}

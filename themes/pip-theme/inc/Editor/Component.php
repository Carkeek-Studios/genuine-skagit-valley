...
class Component implements Component_Interface {
	...
	public function action_add_editor_support() {
		...
		register_block_pattern_category(
			'elements',
			array( 'label' => _x( 'Elements', 'Block pattern category', 'pip-theme' ) )
		);

		register_block_pattern(
			'carkeek-blocks/centered-cta',
			array(
				'title'       => __( 'Centered CTA', 'pip-theme' ),
				'description' => _x( 'Centered CTA', 'Block pattern description', 'pip-theme' ),
		...
		register_block_pattern(
			...
			array(
				'title'       => __( 'Class List with Intro', 'pip-theme' ),
				'description' => _x( 'Header, Intro, Class List and Link', 'Block pattern description', 'pip-theme' ),
				'categories'  => array( 'layout' ),
		...
		register_block_pattern(
			...
			array(
				'title'       => __( 'Store with Intro', 'pip-theme' ),
				'description' => _x( 'Header, Intro, Shop Products and Link', 'Block pattern description', 'pip-theme' ),
				'categories'  => array( 'layout' ),
				'content'     => '<!-- wp:group {"align":"full"} -->
		...
		register_block_pattern(
			...
			array(
				'title'       => __( 'Instagram with Intro', 'pip-theme' ),
				'description' => _x( 'Instagram, Intro, Shop Products and Link', 'Block pattern description', 'pip-theme' ),
				'categories'  => array( 'layout' ),

...
<body yahoo="fix" alink="#006caa" link="#006caa" text="#000000" bgcolor="#ffffff" style="width:100% !important; -webkit-text-size-adjust:100%; -ms-text-size-adjust:100%; margin:0 auto; padding:20px 0 0 0; background:#ffffff; min-height:1000px;">
	<div style="margin:0; padding:0; width:100% !important; font-family: 'Helvetica Neue', Helvetica, sans-serif; font-size:14px; line-height:145%; text-align:left;">
		...
		<h1><?php esc_html_e( 'Important changes to your class registration', 'event-tickets' ); ?></h1>

		<p>
			<?php
			$message = _n(
				'We wanted to let you know that a class registration you purchased for %2$s has been transferred to %3$s%4$s. Your registration remains valid and no further action is needed on your part:',
				'We wanted to let you know that the following %1$s registration for %2$s has been transferred to %3$s%4$s. Your existing registration remains valid and no further action is needed on your part:',

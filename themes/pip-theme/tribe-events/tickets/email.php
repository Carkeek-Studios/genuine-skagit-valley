 ...
 *
 * PKO - Only made a few edits to the template - added an image and edited the footer.
 */
?>
	...
	<div style="margin:0; padding:0; width:100% !important; font-family: 'Helvetica Neue', Helvetica, sans-serif; font-size:14px; line-height:145%; text-align:left;">
		<center>
			...
			foreach ( $tickets as $ticket ) {
				...
				error_log(print_r($header_img, true));
				$venue_label = '';
				$venue_name = null;
							...
							<table class="inner-wrapper" border="0" cellpadding="0" cellspacing="0" width="620" bgcolor="#f7f7f7" style="margin:0 auto !important; width:620px; padding:0;">
								<tr>
									<td valign="top" class="ticket-content" align="left" width="580" border="0" cellpadding="20" cellspacing="0" style="padding:20px; background:#f7f7f7;">
											...
											<table border="0" cellpadding="0" cellspacing="0" width="100%">
												<tr>
													<td class="ticket-image" valign="top" align="left" width="100%" style="padding-bottom:15px !important;">
														<img src="<?php echo get_template_directory_uri(); ?>/assets/images/PIP_Anchor_Logo-300x113.png" width="250" alt="Partners in Print" style="border:0; outline:none; height:auto; max-width:100%; display:block; margin-bottom:16px" />
													</td>
												</tr>
											</table>
										...
										<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
											<tr>
												<td class="ticket-footer" valign="top" align="left" width="100%" style="padding: 25px 0 0 0 !important; width:100%; margin:0 !important;border-top:1px solid #ccc">
												Partners in Print brings people together by using old printing presses to amplify new voices, share knowledge, and spark creativity.
													<a href="<?php echo esc_url( home_url() ); ?>" style="color:#006caa !important; display:block; margin-top:20px; font-family: 'Helvetica Neue', Helvetica, sans-serif; font-size:13px; text-decoration:underline;">partnersinprint.org</a>
												</td>
											</tr>
										</table>
									</td>

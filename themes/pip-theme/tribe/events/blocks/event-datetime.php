...
?>
<div class="ck-tribe-events-schedule tribe-clearfix">
	<div class="ck-tribe-events-schedule__datetime">
		<?php if ( $is_same_day && ! $is_all_day ) : ?>

			<div class="ck-tribe-events-schedule__date ck-tribe-events-schedule__date--start">
				<?php echo esc_html( $formatted_start_date ); ?>
			</div>
			<div class="ck-tribe-events-schedule__time ck-tribe-events-schedule__time--end">
				<?php echo esc_html( $formatted_start_time ); ?> - <?php echo esc_html( $formatted_end_time ); ?> <?php echo esc_html( $time_zone_label ); ?>
			</div>
		<?php else : ?>
			<span class="ck-tribe-events-schedule__date ck-tribe-events-schedule__date--start">
			<?php echo esc_html( $formatted_start_date ); ?>
		</span>
				<?php if ( ! $is_all_day ) : ?>
					<span class="ck-tribe-events-schedule__separator ck-tribe-events-schedule__separator--date">
						<?php echo esc_html( $separator_date ); ?>
					</span>
					<span class="ck-tribe-events-schedule__time ck-tribe-events-schedule__time--start">
						<?php echo esc_html( $formatted_start_time ); ?>
					</span>
				<?php elseif ( $is_same_day ) : ?>
					<span class="ck-tribe-events-schedule__all-day"><?php echo esc_html__( 'All day', 'the-events-calendar' ); ?></span>
				<?php endif; ?>

				<?php if ( ! $is_same_start_end ) : ?>
					<?php if ( ! $is_all_day || ! $is_same_day ) : ?>
						<span class="ck-tribe-events-schedule__separator ck-tribe-events-schedule__separator--time">
							<?php echo esc_html( $separator_time ); ?>
						</span>
					<?php endif; ?>

					<?php if ( ! $is_same_day ) : ?>
						<span class="ck-tribe-events-schedule__date ck-tribe-events-schedule__date--end">
						...
						<?php if ( ! $is_all_day ) : ?>
							...
							<span class="ck-tribe-events-schedule__time ck-tribe-events-schedule__time--end">
					...
					<?php if ( $show_time_zone ) : ?>
						<span class="ck-tribe-events-schedule__timezone"><?php echo esc_html( $time_zone_label ); ?></span>
					<?php endif; ?>
				<?php endif; ?>
			<?php endif; ?>
			</div>

...
(function ($) {
  function setUpQty() {
    var plus = '<button class="quantity-button plus">+<span class="screen-reader-text">Subtract 1</span></button>';
    var minus = '<button class="quantity-button minus">-<span class="screen-reader-text">Subtract 1</span></button>';

 ...
 * * `waflt_theme()->is_primary_sidebar_active()`
 * * `waflt_theme()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		register_sidebar(
			array(
				'name'          => esc_html__( 'Footer Upper', 'waflt-theme' ),
				'id'            => static::FOOTER_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Footer Widgets Top', 'waflt-theme' ),
		...
		register_sidebar(
			array(
				'name'          => esc_html__( 'Footer Lower', 'waflt-theme' ),
				'id'            => static::FOOTER_LOWER_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Footer Widgets Lower Section (includes HR)', 'waflt-theme' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div>',
				'before_title'  => '<h2 class="widget-title">',
				'after_title'   => '</h2>',

...
class Component implements Component_Interface {
	...
	public function action_customize_register( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				...
				'choices' => array(
					'title_tagline' => __( 'Display Title & Tagline', 'waflt-theme' ),
					'title_only'    => __( 'Display Title Only', 'waflt-theme' ),
					'tagline_only'    => __( 'Display Tagline Only', 'waflt-theme' ),
					'none'          => __( 'Hide Title & Tagline', 'waflt-theme' ),
				),
			)
		);
		...
		$wp_customize->add_section(
			'theme_options',
			array(
				'title'    => __( 'Theme Options', 'waflt-theme' ),
	...
	public function action_enqueue_customize_preview_js() {
		wp_enqueue_script(
			'waflt-theme-customizer',
			get_theme_file_uri( '/assets/js/customizer.min.js' ),
			array( 'customize-preview' ),
			waflt_theme()->get_asset_version( get_theme_file_path( '/assets/js/customizer.min.js' ) ),
			true
		);
	}
}

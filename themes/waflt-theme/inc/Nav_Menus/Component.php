 ...
 * * `waflt_theme()->is_primary_nav_menu_active()`
 * * `waflt_theme()->display_primary_nav_menu( array $args = [] )`
 */
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_nav_menus() {
		register_nav_menus(
			array(
				static::PRIMARY_NAV_MENU_SLUG   => esc_html__( 'Primary', 'waflt-theme' ),
				static::SECONDARY_NAV_MENU_SLUG => esc_html__( 'Secondary', 'waflt-theme' ),
				static::CAMPAIGNFOOTER_NAV_MENU_SLUG => esc_html__( 'Campaign', 'waflt-theme' ),
			)
		);
	}

...
/* global wafltThemeScreenReaderText */
...
function initEachNavToggleSubmenu(nav) {
  ...
  for (var i = 0; i < SUBMENUS.length; i++) {
    ...
    firstSubItem.appendChild(childDropdownButton); // Toggle the submenu when we click the dropdown button.
...
function toggleSubMenu(parentMenuItem, forceToggle) {
  ...
  if (parentMenuItemToggled) {
    ...
    toggleButton.setAttribute('aria-label', wafltThemeScreenReaderText.expand);
    ...
    toggleButton.setAttribute('aria-label', wafltThemeScreenReaderText.collapse);
  }
}
/**
...
function getDropdownButton() {
  ...
  dropdownButton.setAttribute('aria-label', wafltThemeScreenReaderText.expand);

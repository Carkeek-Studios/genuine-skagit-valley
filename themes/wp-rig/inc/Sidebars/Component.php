...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		...
		register_sidebar(
			array(
				'name'          => esc_html__( 'Blog Archive Intro', 'wp-rig' ),
				'id'            => static::BLOG_ARCHIVE_SLUG,
				'description'   => esc_html__( 'Place content that will appear on the blog archive below the title and above the filters', 'wp-rig' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div>',
				'before_title'  => '<h2 class="widget-title">',
				'after_title'   => '</h2>',
		...
		register_sidebar(
			array(
				'name'          => esc_html__( 'Header Top', 'wp-rig' ),
				'id'            => 'header-top',
				'description'   => esc_html__( 'Appears above the nav', 'wp-rig' ),
				'before_widget' => '<div id="%1$s" class="widget %2$s">',
				'after_widget'  => '</div>',
				'before_title'  => '<h2 class="widget-title">',
				'after_title'   => '</h2>',
